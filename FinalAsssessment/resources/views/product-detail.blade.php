    ...
    <div class="lg:w-4/5 mx-auto flex flex-wrap">
      ...
      <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <div class="flex">
          ...
          <button class="flex ml-auto text-purple bg-white border-0 py-2 px-6 focus:outline-none hover:bg-purple hover:text-white rounded">Add to Cart</button> </a>
          <a href="{{route('addwishlist',['id'=>$product->id])}}">
          <button class="rounded-full w-10 h-10 bg-gray-200 p-0 border-0 inline-flex items-center justify-center text-gray-500 ml-4 ">
            <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5 hover:text-red-500" viewBox="0 0 24 24">
